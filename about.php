            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1>About Us <span class="d-block"></span></h1>
                        <p class="mb-5"> "Embark on a musical journey with us and immerse yourself in the captivating waves of our marching band's melodies, where traditions meet innovation, creating a harmonious blend that defines our unique and powerful sound."</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="Image/person_1.jpg" class="img-fluid mb-5">
                ...
                <!-- Start Column 2 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="Image/person_2.jpg" class="img-fluid mb-5">
                ...
                <!-- Start Column 3 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="Image/person_3.jpg" class="img-fluid mb-5">
                ...
                <!-- Start Column 4 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="Image/person_4.jpg" class="img-fluid mb-5">
