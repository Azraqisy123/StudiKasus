...
$id = $_GET['id'];
$percussion = mysqli_query($connection, "SELECT * FROM produk WHERE ID_Produk = '$id' ");

while ($percussion_data = mysqli_fetch_array($percussion)) {
    $ID_Produk = $percussion_data['ID_Produk'];
    $Nama_Produk = $percussion_data['Nama_Produk'];
    $Harga = $percussion_data['Harga'];
    $Stok = $percussion_data['Stok'];
}
?>
    ...
    <div class="p-4">
        <div class="row">
            <div class="mx-auto col-10 col-md-8 col-lg-6">
                <form action="action_edit_percussion.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <div class="col-md-2">
                            <label for="exampleFormControlInput1" class="form-label">ID Product</label>
                            <input type="text" class="form-control" name="ID_Produk" value="<?php echo $ID_Produk; ?>" required>
                        </div>
                        <div class="col">
