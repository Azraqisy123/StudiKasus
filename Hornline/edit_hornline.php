...
$id = $_GET['id'];
$hornline = mysqli_query($connection, "SELECT * FROM produk WHERE ID_Produk = '$id' ");

while ($hornline_data = mysqli_fetch_array($hornline)) {
    $ID_Produk = $hornline_data['ID_Produk'];
    $Nama_Produk = $hornline_data['Nama_Produk'];
    $Harga = $hornline_data['Harga'];
    $Stok = $hornline_data['Stok'];
}
?>
    ...
    <div class="p-4">
        <div class="row">
            <div class="mx-auto col-10 col-md-8 col-lg-6">
                <form action="action_edit_hornline.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <div class="col-md-2">
